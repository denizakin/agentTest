-- Materialized view: 1h ETH-USDT OHLCV (pure PostgreSQL)

DROP MATERIALIZED VIEW IF EXISTS mv_candlesticks_eth_1h;
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_mv_candles_eth_1h_ts
