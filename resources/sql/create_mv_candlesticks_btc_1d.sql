-- Materialized view: 1d BTC-USDT OHLCV (pure PostgreSQL)

DROP MATERIALIZED VIEW IF EXISTS mv_candlesticks_btc_1d;
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_mv_candles_btc_1d_ts
