-- Materialized view: 1d ETH-USDT OHLCV (pure PostgreSQL)

DROP MATERIALIZED VIEW IF EXISTS mv_candlesticks_eth_1d;
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_mv_candles_eth_1d_ts
