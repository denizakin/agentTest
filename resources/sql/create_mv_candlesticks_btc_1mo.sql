-- Materialized view: 1 month BTC-USDT OHLCV (pure PostgreSQL)

DROP MATERIALIZED VIEW IF EXISTS mv_candlesticks_btc_1mo;
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_mv_candles_btc_1mo_ts
