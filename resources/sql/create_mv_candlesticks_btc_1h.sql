-- Materialized view: 1h BTC-USDT OHLCV (pure PostgreSQL)

DROP MATERIALIZED VIEW IF EXISTS mv_candlesticks_btc_1h;
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_mv_candles_btc_1h_ts
